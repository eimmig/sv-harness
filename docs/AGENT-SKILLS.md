...
- **Architecture Diagram Builder** / **Current Architecture Documenter**: usar para **conferir**
  se a implementação bate com [[ARCHITECTURE]]/[[DATA-MODEL]] — nunca para gerar diagrama
  paralelo como fonte nova (mesma ressalva do Impeccable/taste-skill sobre [[DESIGN-SYSTEM]]:
...
- **System Design Baseline Builder**: apoio ao esclarecer requisitos/restrições mensuráveis
  quando uma feature ambígua aparecer — complementa [[REQUIREMENTS]], não substitui.
...
- **Test Strategy Planner**: antes de escrever os testes de uma feature, definir estratégia
  baseada em risco — complementa [[TESTING]] (que já define frameworks/meta de cobertura por
...
- [[CONVENTIONS]], [[TESTING]], [[ARCHITECTURE]] — fontes de verdade que as skills auditam, mas
  não substituem.
- [[DESIGN-SYSTEM]] — mesma ressalva de "auditoria, não fonte nova" aplicada a Impeccable/
